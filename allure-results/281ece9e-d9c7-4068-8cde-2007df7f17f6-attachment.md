...
- contentinfo:
  ...
  - list:
    ...
    - listitem:
      - link "Coding Jag - Issue 258":
        - /url: /newsletter/editions/issue258
    - listitem:
      - link "Best Egg [Case Study]":
        - /url: /customers/best-egg
    - listitem:
      - link "XPath in Selenium [Blog]":
        - /url: /blog/complete-guide-for-using-xpath-in-selenium-with-examples/
    - listitem:
      - link "Information Architecture [Hub]":
        - /url: /learning-hub/information-architecture
    - listitem:
